...
This package provides an interface to access the expression data
programmatically. 
...
([Docs](https://seandavi.github.io/SRAdbV2/articles/SRAdbv2.html)).

You will need to install, then load the library.

*** Edit 30th May 2019: The URL hosting the API is down, meaning that queries to
SRAdbV2 as demonstrated beloware not working. We will update when there's a
