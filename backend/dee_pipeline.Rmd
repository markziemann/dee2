...
species_names <- c("'Arabidopsis thaliana'","'Caenorhabditis elegans'",
...
Previously I fetched all data pre 2023, and so now I only need to get 2023 data fresh.

This means that each january this script should be updated.

```{r,fetchmetadata}

CSVOLD=paste(SRADBWD,"/",org,"_2022.csv",sep="")

CSVNEW=paste(SRADBWD,"/",org,"_2023.csv",sep="")
...
MY_SRA_CMD <- paste('bash metadata_dl_2023.sh', org)
MY_SRA_CMD
system(MY_SRA_CMD)
...
GEOOLD=paste(SRADBWD,"/",org,"_geo_2022.csv",sep="")

GEONEW=paste(SRADBWD,"/",org,"_geo_2023.csv",sep="")
...
ESEARCH <- esearch(term = MY_GEO_QUERY_TERM , db = "gds", rettype = "uilist",
  ...
  datetype = "pdat", reldate = NULL, mindate = "2000/01/01", maxdate = "2022/12/31")
...
ESEARCH <- esearch(term = MY_GEO_QUERY_TERM , db = "gds", rettype = "uilist",
  retmode = "json", retstart = 0, retmax = 500000000, usehistory = TRUE,
  webenv = NULL, querykey = NULL, sort = NULL, field = NULL,
  datetype = "pdat", reldate = NULL, mindate = "2023/01/01", maxdate = "2023/12/31")
