...
pysra_cmd <- paste("~/miniconda3/bin/python -m pysradb search -d geo -m 10000 -O ", species_name, " -C TRANSCRIPTOMIC -D 01-01-2025:31-12-2025 --detailed ")
...
GEOFILENAME = paste(SRADBWD,"/",org,"_geo_2025.csv",sep="")
...
CMDX=paste('ssh -i ~/.ssh/dee2_2025 ubuntu@dee2.io "ls /dee2_data/data/',org,'"' , sep="")
...
rsync_command <- "rsync -azh -e \"ssh -i  ~/.ssh/dee2_2025 \" ORG ubuntu@dee2.io:/dee2_data/data/"
