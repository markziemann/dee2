...
MAX=1000000
z2 <- animaldf
bb <- barplot( t(z2), beside=TRUE , xlim=c(0,MAX), main="Animals", col=c("darkblue","red") ,
  horiz=T , las=1, cex.axis=1.2, cex.names=1.3, cex.main=1.4, xlab="number of SRA runs")
legend("topright", colnames(z2), fill=c("darkblue","red") , cex=0.9)
...
MAX=150000
z2 <- plantdf
bb <- barplot( t(z2), beside=TRUE , xlim=c(0,MAX), main="Plants", col=c("darkblue","red") ,
  horiz=T , las=1, cex.axis=1.2, cex.names=1.3, cex.main=1.4, xlab="number of SRA runs")
...
MAX=50000
z2 <- microbedf
bb <- barplot( t(z2), beside=TRUE , xlim=c(0,MAX), main="Microbes", col=c("darkblue","red"),
horiz=T , las=1, cex.axis=1.2, cex.names=1.3, cex.main=1.4, xlab="number of SRA runs")
text( cbind(as.numeric(z2[,1])+10000 ,as.numeric(z2[,2])+10000 ),
  t(bb),labels=c(z2[,1],z2[,2]) ,cex=1.15)
