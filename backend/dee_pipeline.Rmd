...
Previously I fetched all data 2025 and before, and so now I only need to get 2026 data fresh.

This means that each january this script should be updated.

```{r,fetchmetadata}

CSVOLD=paste(SRADBWD,"/",org,"_2025.csv",sep="")

CSVNEW=paste(SRADBWD,"/",org,"_2026.csv",sep="")
...
MY_SRA_CMD <- paste('bash metadata_dl_2026.sh', org)
MY_SRA_CMD
system(MY_SRA_CMD)
