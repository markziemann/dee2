...
bdistachyon gmax hvulgare ptrichocarpa sbicolor slycopersicum stuberosum taestivum vvinifera
mmulatta ggallus sscrofa btaurus oaries mfascicularis pfalciparum pvivax ; do
...
#org
#org="ecoli"
mmulatta, ggallus, sscrofa, btaurus, oaries, mfascicularis, pfalciparum, pvivax

species_list <- c("3702", "4530", "4577", "6239", "7227", "7955",
  "562", "9606", "10090", "10116", "4932",
  "15368", "3847", "1753", "3694", "4558",
  "1753", "4113", "4565", "1753",
  "9544", "9031", "9823", "9913", "9940", "9541", "5833", "5855")
...
names(species_list) <- c("athaliana", "osativa", "zmays",
  ...
  "mmulatta", "ggallus", "sscrofa", "btaurus", "oaries",
  "mfascicularis", "pfalciparum", "pvivax")
...
species_names <- c("'Arabidopsis thaliana'", "'Oryza sativa'",
  ...
  "'Vitis vinifera'","'Macaca mulatta'",
  "'Gallus gallus'", "'Sus scrofa'",
  "'Bos taurus'", "'Ovis aries'",
  "'Macaca fascicularis'", "'Plasmodium falciparum'",
  "'Plasmodium vivax'")
...
numgenes <- c(27655, 35806, 39756, 20362, 13918, 25903, 4140, 20338, 22598, 22250, 6692,
  ...
  40304, 25635, 35217, 37580, 56826, 37093, 5188, 5433)
