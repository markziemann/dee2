...
if [ ! -r started ] ; then
  ...
  PREV_REFERENCE_PIPELINE_MD5SUM15="2b2bc54861a5b4f8fd2bdba326f18492"
  PREV_REFERENCE_PIPELINE_MD5SUM16="0ea5fb3b64a340afb0068750a754d59c"
  PREV_REFERENCE_PIPELINE_MD5SUM17="3d9c6179da742a05585102c17953f2e3"
  PREV_REFERENCE_PIPELINE_MD5SUM18="95b4a31b8ac48de5149e02051a1802ec"
  PREV_REFERENCE_PIPELINE_MD5SUM19="35714b55a8b47a86a5afaa85227073a9"
  PREV_REFERENCE_PIPELINE_MD5SUM20="d41d8cd98f00b204e9800998ecf8427e"
    ...
    for FILE in $(find ${INCOMING} ${STASH}) ; do
      ...
      if [ "$(echo $FILE | grep -c .zip$)" -ne "1" ] ; then
        ...
        if [ $((TIME-FILETIME)) -gt "60" ] ; then
          ...
          && [ "$PREV_REFERENCE_PIPELINE_MD5SUM14" != "$PIPELINE_MD5SUM" ] \
          && [ "$PREV_REFERENCE_PIPELINE_MD5SUM15" != "$PIPELINE_MD5SUM" ] \
          && [ "$PREV_REFERENCE_PIPELINE_MD5SUM16" != "$PIPELINE_MD5SUM" ] \
          && [ "$PREV_REFERENCE_PIPELINE_MD5SUM17" != "$PIPELINE_MD5SUM" ] \
